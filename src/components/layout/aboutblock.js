    ...
    return (
        <main id="aboutblock" className="about">
            ...
            <div className="about-text">
                ...
                If you'd like to find out more about the interesting personality I never knew I had, you can check out my basic <Link to="/blog">opinions</Link>, my basic <a href="/">art</a>, or go find me &#x2197; while I get lost in space.</p>
            </div>
